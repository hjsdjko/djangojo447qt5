...
<!-- 商品推荐 -->
<div id="animate_recommendyinlexinxi" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"76%","padding":"60px 0 0","margin":"0px auto","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231010/f0b8580773a548e68d6b92e646873f96.png) no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"24px","color":"#000","fontWeight":"500","display":"block"}'>音乐信息推荐</span>
	</div>
		...
		<div v-if="yinlexinxiRecommend.length" class="list list16 index-pv1" :style='{"padding":"0 12%","margin":"20px 0 0","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="item,index in yinlexinxiRecommend" :key="index"  @click="toDetail('yinlexinxiDetail', item)" class="list-item animation-box">
		    ...
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0 10px","flexWrap":"wrap","display":"flex"}'>
				...
				<div class="title">{{item.yinlefenlei}}</div>
		      ...
		      <div class="desc" v-html="item.geci"></div>
		    </div>
		  </div>
		</div>
	
	<div @click="moreBtn('yinlexinxi')" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px 0 0","margin":"90px -12px 0 0","textAlign":"right","display":"block","right":"12%","top":"0","background":"url(http://codegen.caihongy.cn/20231010/b345185c76ac4a77bf4cd6f6171a72ed.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"73px","position":"absolute","height":"80px"}'>
...
<!-- 商品推荐 -->
<div id="animate_recommendgequxinxi" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"76%","padding":"60px 0 0","margin":"0px auto","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231010/f0b8580773a548e68d6b92e646873f96.png) no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"24px","color":"#000","fontWeight":"500","display":"block"}'>歌曲数据推荐</span>
	</div>
		...
		<div v-if="gequxinxiRecommend.length" class="list list16 index-pv1" :style='{"padding":"0 12%","margin":"20px 0 0","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="item,index in gequxinxiRecommend" :key="index"  @click="toDetail('gequxinxiDetail', item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid red","width":"100%","padding":"0px","overflow":"hidden","height":"320px"}' class="img-box">
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-if="preHttp(item.picture)" :src="item.picture.split(',')[0]" alt="" />
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-else :src="baseUrl + (item.picture?item.picture.split(',')[0]:'')" alt="" />
			</div>
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0 10px","flexWrap":"wrap","display":"flex"}'>
		      ...
		      <div class="desc" v-html="item.jieshao"></div>
		    </div>
		  </div>
		</div>
	
	<div @click="moreBtn('gequxinxi')" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px 0 0","margin":"90px -12px 0 0","textAlign":"right","display":"block","right":"12%","top":"0","background":"url(http://codegen.caihongy.cn/20231010/b345185c76ac4a77bf4cd6f6171a72ed.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"73px","position":"absolute","height":"80px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
		<i :style='{"color":"#333","fontSize":"16px","display":"none"}' class="icon iconfont icon-jiantou09"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendyinlexinxi',css:'animate__'},
				{id:'animate_recommendgequxinxi',css:'animate__'},
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          autoSortUrl = "gequxinxi/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "gequxinxi/autoSort2";
          }
			data = {
				page: 1,
				limit: 8,
			...
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.gequxinxiRecommend = res.data.data.list;
