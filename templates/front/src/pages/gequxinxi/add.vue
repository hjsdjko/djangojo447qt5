...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="收藏" prop="shoucang">
            <el-input v-model.number="ruleForm.shoucang" 
                placeholder="收藏" clearable :disabled=" false  ||ro.shoucang"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="分享" prop="share">
            <el-input v-model.number="ruleForm.share" 
                placeholder="分享" clearable :disabled=" false  ||ro.share"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="评论" prop="pinglun">
            <el-input v-model.number="ruleForm.pinglun" 
                placeholder="评论" clearable :disabled=" false  ||ro.pinglun"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="播放" prop="bofang">
            <el-input v-model.number="ruleForm.bofang" 
                placeholder="播放" clearable :disabled=" false  ||ro.bofang"></el-input>
          </el-form-item>
