...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="编曲" prop="bianqu">
            <el-input v-model="ruleForm.bianqu" 
                placeholder="编曲" clearable :disabled=" false  ||ro.bianqu"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="填词" prop="tianci">
            <el-input v-model="ruleForm.tianci" 
                placeholder="填词" clearable :disabled=" false  ||ro.tianci"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="时长" prop="shizhang">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="发行方" prop="faxingfang">
            <el-input v-model="ruleForm.faxingfang" 
                placeholder="发行方" clearable :disabled=" false  ||ro.faxingfang"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="发行日期" prop="faxingriqi">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="歌词" prop="geci">
            <editor 
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('yinlexinxi/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`yinlexinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
