		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gequxinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="gequxinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>歌曲数据总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{gequxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>歌曲数据</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="shoucang" label="收藏"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="share" label="分享"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pinglun" label="评论"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="bofang" label="播放"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gequxinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gequxinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gequxinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'gequxinxiChart1');
...
//统计接口2
    gequxinxiChat2() {
      this.$nextTick(()=>{
        ...
        var gequxinxiChart2 = echarts.init(document.getElementById("gequxinxiChart2"),'macarons');
        this.$http({
            url: `gequxinxi/value/title/shoucang`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                gequxinxiChart2.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, gequxinxiChart2)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    gequxinxiChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    gequxinxiChat3() {
      this.$nextTick(()=>{
        ...
        var gequxinxiChart3 = echarts.init(document.getElementById("gequxinxiChart3"),'macarons');
        this.$http({
            url: `gequxinxi/value/title/share`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                gequxinxiChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    gequxinxiChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    gequxinxiChat4() {
      this.$nextTick(()=>{
        ...
        var gequxinxiChart4 = echarts.init(document.getElementById("gequxinxiChart4"),'macarons');
        this.$http({
            url: `gequxinxi/value/title/pinglun`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                gequxinxiChart4.setOption(option);
				
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, gequxinxiChart4)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    gequxinxiChart4.resize();
				},false);
            }
        });
      })
...
//统计接口5
    gequxinxiChat5() {
      this.$nextTick(()=>{
        ...
        var gequxinxiChart5 = echarts.init(document.getElementById("gequxinxiChart5"),'macarons');
        this.$http({
            url: `gequxinxi/value/title/bofang`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                gequxinxiChart5.setOption(option);


                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    gequxinxiChart5.resize();
					},false);
            }
        });
      })
